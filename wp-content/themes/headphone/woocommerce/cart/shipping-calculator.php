...
do_action( 'woocommerce_before_shipping_calculator' ); ?>
    ...
    <form class="custom-shipping-calculator-form" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
        ...
        <div class="col_full">
            <div class="col_half">
                <?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_country', true ) ) : ?>
                    <select name="calc_shipping_country" id="calc_shipping_country" class="sm-form-control" rel="calc_shipping_state">
            ...
            <?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_state', true ) ) : ?>
                <div class="col_half col_last" id="calc_shipping_state_field">
                    <?php
            ...
            <?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_city', true ) ) : ?>
                <div class="col_half" id="calc_shipping_city_field">
                    <input type="text" class="input-text" value="<?php echo esc_attr( WC()->customer->get_shipping_city() ); ?>" placeholder="<?php esc_attr_e( 'City', 'woocommerce' ); ?>" name="calc_shipping_city" id="calc_shipping_city" />
                </div>
            <?php endif; ?>

            <?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_postcode', true ) ) : ?>
                <div class="col_half col_last" id="calc_shipping_postcode_field">
                    <input type="text" class="input-text" value="<?php echo esc_attr( WC()->customer->get_shipping_postcode() ); ?>" placeholder="<?php esc_attr_e( 'Postcode / ZIP', 'woocommerce' ); ?>" name="calc_shipping_postcode" id="calc_shipping_postcode" />
                </div>
            <?php endif; ?>

            <div class="col_half"><button type="submit" name="calc_shipping" value="1" class="button custom-update-cal-shipping-price"><?php esc_html_e( 'Update Total', 'woocommerce' ); ?></button></div>
